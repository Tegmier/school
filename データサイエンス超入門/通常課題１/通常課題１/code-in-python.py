...
df_test = df[df["取引時点"] == '2022年第４四半期']
df_latest = df.sort_values(by = '取引時点', ascending= False, inplace = True)
df_recent = df_latest.iloc[0:50000,:]
df_random = df.smaple(n = 50000, random = 42)
